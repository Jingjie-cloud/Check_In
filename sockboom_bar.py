...
def sockboom():
  try:
    ...
    driver.find_element_by_xpath("//*[@id='email' and @type='email']").send_keys('349814342@qq.com')
    driver.find_element_by_xpath("//*[@id='passwd' and @type='password']").click()
    driver.find_element_by_xpath("//*[@id='passwd' and @type='password']").send_keys('!@#$WERTdfgh')
...
#     ActionChains(driver).move_to_element(sure).click().perform()
    driver.find_element_by_xpath("/html/body/div[1]/div[2]/main/section/div/section[2]/div/div[1]/div[2]/div/div/div/div[1]/div/div/div[8]/div/span[4]").click()
    driver.implicitly_wait(3)
